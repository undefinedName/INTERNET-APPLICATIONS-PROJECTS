...
$ucid = $_SESSION["UCID"];
echo "Welcome! <br><br> Displaying the transactions.php page for $ucid. <br><br>";
...
<form action = "deposit-or-withdraw_stub.php">

<label for="Amount">Amount</label><br>
<input type=text name="Amount" id="Amount"><br><br>

<label for="Type">What would you like to do?</label><br>
